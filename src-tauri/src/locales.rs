...
pub fn app_name(locale: Locale) -> &'static str {
    match locale {
        Locale::ZhCn => "fastnote",
        Locale::EnUs => "fastnote",
        Locale::ZhHk => "fastnote",
    }
}
...
pub fn notepad_window_title(locale: Locale) -> &'static str {
    match locale {
        Locale::ZhCn => "fastnote 便签",
        Locale::EnUs => "fastnote Quick Note",
        Locale::ZhHk => "fastnote 便箋",
    }
}

pub fn tile_window_title(locale: Locale) -> &'static str {
    match locale {
        Locale::ZhCn => "fastnote 磁贴",
        Locale::EnUs => "fastnote Tile",
        Locale::ZhHk => "fastnote 磁貼",
    }
}
...
mod tests {
    ...
    fn localizes_native_shell_strings_for_supported_locales() {
        assert_eq!(app_name(Locale::ZhCn), "fastnote");
        assert_eq!(app_name(Locale::EnUs), "fastnote");
        assert_eq!(app_name(Locale::ZhHk), "fastnote");

        assert_eq!(notepad_window_title(Locale::EnUs), "fastnote Quick Note");
        assert_eq!(tile_window_title(Locale::ZhHk), "fastnote 磁貼");
        assert_eq!(tray_tooltip(Locale::EnUs), "fastnote");
    ...
    fn localizes_macos_native_menu_strings_for_supported_locales() {
        ...
        assert_eq!(macos_menu_about_label(Locale::ZhCn), "关于fastnote");
        assert_eq!(macos_menu_about_label(Locale::EnUs), "About fastnote");
        assert_eq!(macos_menu_services_label(Locale::ZhHk), "服務");
        assert_eq!(macos_menu_hide_app_label(Locale::ZhCn), "隐藏fastnote");
        assert_eq!(macos_menu_hide_others_label(Locale::EnUs), "Hide Others");
        assert_eq!(macos_menu_quit_app_label(Locale::EnUs), "Quit fastnote");
